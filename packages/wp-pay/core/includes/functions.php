 ...
 * @return Payment|null
 */
function get_wpayo_payment( $post_id ) {
 ...
 * @return Payment|null
 */
function get_wpayo_payment_by_meta( $meta_key, $meta_value, $args = [] ) {
	$args['posts_per_page'] = 1;

	$payments = get_wpayo_payments_by_meta( $meta_key, $meta_value, $args );
 ...
 * @return Payment[]
 */
function get_wpayo_payments_by_meta( $meta_key, $meta_value, $args = [] ) {
	$payments = [];
	...
	foreach ( $query->posts as $p ) {
		$payment = get_wpayo_payment( $p->ID );
 ...
 * @return Payment|null
 */
function get_wpayo_payment_by_purchase_id( $purchase_id ) {
	return get_wpayo_payment_by_meta( '_wpayo_payment_purchase_id', $purchase_id );
}
 ...
 * @return Payment|null
 */
function get_wpayo_payment_by_transaction_id( $transaction_id ) {
	return get_wpayo_payment_by_meta( '_wpayo_payment_transaction_id', $transaction_id );
}
 ...
 * @return Payment[]
 */
function get_wpayo_payments_by_user_id( $user_id = null ) {
	if ( null === $user_id ) {
		$user_id = \get_current_user_id();
	}

	return get_wpayo_payments_by_meta( null, null, [ 'author' => $user_id ] );
}
 ...
 * @return Payment[]
 */
function get_wpayo_payments_by_source( $source, $source_id = null ) {
	// Meta query.
	$meta_query = [
		[
			'key'   => '_wpayo_payment_source',
			'value' => $source,
		],
	];
	...
	return get_wpayo_payments_by_meta( null, null, $args );
}
